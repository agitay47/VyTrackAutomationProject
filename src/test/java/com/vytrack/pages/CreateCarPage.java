...
public class CreateCarPage extends BasePage {
    ...
    public WebElement getCreateCarRtn() {
        return createCarBtn;
    }
    ...
    public WebElement getModelYearInput() {
        return modelYearInput;
    }
    ...
    public void enterLicensePlate(String licensePlate) {
        ...
        licencePlateInputBox.click();
        getLicencePlateInputBox().sendKeys(licensePlate);
    }

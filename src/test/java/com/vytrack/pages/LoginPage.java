...
public class LoginPage extends BasePage {
    ...
    private WebElement username;        // private will help you to privente from loosing webelements from step. deff. class,
    // to do not use web elements directly in step. deff. classes
